...
public class sim3 extends Fragment {


    DatabaseReference mRootRef3= FirebaseDatabase.getInstance().getReference();
    DatabaseReference mq = mRootRef3.child("practice/quant/simplification/question/q3");
    DatabaseReference ma = mRootRef3.child("practice/quant/simplification/answer/a3");
    DatabaseReference mo1 = mRootRef3.child("practice/quant/simplification/options/q3/a");
    DatabaseReference mo2 = mRootRef3.child("practice/quant/simplification/options/q3/b");
    DatabaseReference mo3 = mRootRef3.child("practice/quant/simplification/options/q3/c");
    DatabaseReference mo4 = mRootRef3.child("practice/quant/simplification/options/q3/d");
