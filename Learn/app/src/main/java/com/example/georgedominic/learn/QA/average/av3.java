...
public class av3 extends Fragment {

    DatabaseReference mRootRef3= FirebaseDatabase.getInstance().getReference();
    DatabaseReference mq = mRootRef3.child("practice/quant/average/question/q3");
    DatabaseReference ma = mRootRef3.child("practice/quant/average/answer/a3");
    DatabaseReference mo1 = mRootRef3.child("practice/quant/average/options/q3/a");
    DatabaseReference mo2 = mRootRef3.child("practice/quant/average/options/q3/b");
    DatabaseReference mo3 = mRootRef3.child("practice/quant/average/options/q3/c");
    DatabaseReference mo4 = mRootRef3.child("practice/quant/average/options/q3/d");
