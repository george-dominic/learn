...
public class ra3 extends Fragment {
    ...
    DatabaseReference mq = mRootRef3.child("practice/quant/ratio/question/q3");
    DatabaseReference ma = mRootRef3.child("practice/quant/ratio/answer/a3");
    DatabaseReference mo1 = mRootRef3.child("practice/quant/ratio/options/q3/a");
    DatabaseReference mo2 = mRootRef3.child("practice/quant/ratio/options/q3/b");
    DatabaseReference mo3 = mRootRef3.child("practice/quant/ratio/options/q3/c");
    DatabaseReference mo4 = mRootRef3.child("practice/quant/ratio/options/q3/d");
