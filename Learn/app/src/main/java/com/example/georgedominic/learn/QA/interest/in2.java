...
public class in2 extends Fragment {

    DatabaseReference mRootRef2= FirebaseDatabase.getInstance().getReference();
    DatabaseReference mq = mRootRef2.child("practice/quant/interest/question/q2");
    DatabaseReference ma= mRootRef2.child("practice/quant/interest/answer/a2");
    DatabaseReference mo1 = mRootRef2.child("practice/quant/interest/options/q2/a");
    DatabaseReference mo2 = mRootRef2.child("practice/quant/interest/options/q2/b");
    DatabaseReference mo3 = mRootRef2.child("practice/quant/interest/options/q2/c");
    DatabaseReference mo4 = mRootRef2.child("practice/quant/interest/options/q2/d");
