...
public class an1 extends Fragment {
    ...
    DatabaseReference mq = mRootRef1.child("practice/logic/analogy/question/q1");
    DatabaseReference ma = mRootRef1.child("practice/logic/analogy/answer/a1");
    DatabaseReference mo1= mRootRef1.child("practice/logic/analogy/options/q1/a");
    DatabaseReference mo2= mRootRef1.child("practice/logic/analogy/options/q1/b");
    DatabaseReference mo3= mRootRef1.child("practice/logic/analogy/options/q1/c");
    DatabaseReference mo4 = mRootRef1.child("practice/logic/analogy/options/q1/d");
