package com.example.georgedominic.learn.QA.probability;
...
public class prob1 extends Fragment {

    DatabaseReference mRootRef1= FirebaseDatabase.getInstance().getReference();
    DatabaseReference mq = mRootRef1.child("practice/quant/probability/question/q1");
    DatabaseReference ma = mRootRef1.child("practice/quant/probability/answer/a1");
    DatabaseReference mo1= mRootRef1.child("practice/quant/probability/options/q1/a");
    DatabaseReference mo2= mRootRef1.child("practice/quant/probability/options/q1/b");
    DatabaseReference mo3= mRootRef1.child("practice/quant/probability/options/q1/c");
    DatabaseReference mo4 = mRootRef1.child("practice/quant/probability/options/q1/d");
