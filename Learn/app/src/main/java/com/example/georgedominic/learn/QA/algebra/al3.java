package com.example.georgedominic.learn.QA.algebra;
...
public class al3 extends Fragment {

    DatabaseReference mRootRef3= FirebaseDatabase.getInstance().getReference();
    DatabaseReference mq = mRootRef3.child("practice/quant/algebra/question/q3");
    DatabaseReference ma = mRootRef3.child("practice/quant/algebra/answer/a3");
    DatabaseReference mo1 = mRootRef3.child("practice/quant/algebra/options/q3/a");
    DatabaseReference mo2 = mRootRef3.child("practice/quant/algebra/options/q3/b");
    DatabaseReference mo3 = mRootRef3.child("practice/quant/algebra/options/q3/c");
    DatabaseReference mo4 = mRootRef3.child("practice/quant/algebra/options/q3/d");
