...
public class al1 extends Fragment {
    ...
    DatabaseReference mq = mRootRef1.child("practice/quant/algebra/question/q1");
    DatabaseReference ma = mRootRef1.child("practice/quant/algebra/answer/a1");
    DatabaseReference mo1= mRootRef1.child("practice/quant/algebra/options/q1/a");
    DatabaseReference mo2= mRootRef1.child("practice/quant/algebra/options/q1/b");
    DatabaseReference mo3= mRootRef1.child("practice/quant/algebra/options/q1/c");
    DatabaseReference mo4 = mRootRef1.child("practice/quant/algebra/options/q1/d");
