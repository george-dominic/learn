...
public class av2 extends Fragment {
    ...
    DatabaseReference mq = mRootRef2.child("practice/quant/average/question/q2");
    DatabaseReference ma= mRootRef2.child("practice/quant/average/answer/a2");
    DatabaseReference mo1 = mRootRef2.child("practice/quant/average/options/q2/a");
    DatabaseReference mo2 = mRootRef2.child("practice/quant/average/options/q2/b");
    DatabaseReference mo3 = mRootRef2.child("practice/quant/average/options/q2/c");
    DatabaseReference mo4 = mRootRef2.child("practice/quant/average/options/q2/d");
