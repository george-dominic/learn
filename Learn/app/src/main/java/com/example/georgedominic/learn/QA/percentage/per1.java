package com.example.georgedominic.learn.QA.percentage;
...
public class per1 extends Fragment {

    DatabaseReference mRootRef1= FirebaseDatabase.getInstance().getReference();
    DatabaseReference mq = mRootRef1.child("practice/quant/percentage/question/q1");
    DatabaseReference ma = mRootRef1.child("practice/quant/percentage/answer/a1");
    DatabaseReference mo1= mRootRef1.child("practice/quant/percentage/options/q1/a");
    DatabaseReference mo2= mRootRef1.child("practice/quant/percentage/options/q1/b");
    DatabaseReference mo3= mRootRef1.child("practice/quant/percentage/options/q1/c");
    DatabaseReference mo4 = mRootRef1.child("practice/quant/percentage/options/q1/d");
