...
public class al2 extends Fragment {
    ...
    DatabaseReference mq = mRootRef2.child("practice/quant/algebra/question/q2");
    DatabaseReference ma= mRootRef2.child("practice/quant/algebra/answer/a2");
    DatabaseReference mo1 = mRootRef2.child("practice/quant/algebra/options/q2/a");
    DatabaseReference mo2 = mRootRef2.child("practice/quant/algebra/options/q2/b");
    DatabaseReference mo3 = mRootRef2.child("practice/quant/algebra/options/q2/c");
    DatabaseReference mo4 = mRootRef2.child("practice/quant/algebra/options/q2/d");
