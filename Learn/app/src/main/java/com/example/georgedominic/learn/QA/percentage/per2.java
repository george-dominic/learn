...
public class per2 extends Fragment {

    DatabaseReference mRootRef2= FirebaseDatabase.getInstance().getReference();
    DatabaseReference mq = mRootRef2.child("practice/quant/percentage/question/q2");
    DatabaseReference ma= mRootRef2.child("practice/quant/percentage/answer/a2");
    DatabaseReference mo1 = mRootRef2.child("practice/quant/percentage/options/q2/a");
    DatabaseReference mo2 = mRootRef2.child("practice/quant/percentage/options/q2/b");
    DatabaseReference mo3 = mRootRef2.child("practice/quant/percentage/options/q2/c");
    DatabaseReference mo4 = mRootRef2.child("practice/quant/percentage/options/q2/d");
